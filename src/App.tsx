...
function TurkeyListingMap() {
  ...
  const handleMapMove = (event: React.MouseEvent<HTMLDivElement>) => {
    ...
    const city = cityGroup?.getAttribute('data-realty-city') || null;
    if (!city || !mapRef.current) {
      if (activeCityRef.current) { activeCityRef.current = null; setHoveredCity(null); }
      return;
    }
