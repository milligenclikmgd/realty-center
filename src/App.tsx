    ...
    <div className="home-page-static">
      ...
      <section className="border-b border-slate-200 bg-slate-50 py-14 sm:py-16">
        <div className="mx-auto grid max-w-7xl gap-5 px-6 lg:grid-cols-[minmax(0,1.92fr)_minmax(290px,.88fr)] lg:px-12">
          <article className="group relative min-h-[370px] overflow-hidden rounded-3xl bg-slate-900 shadow-xl">
            <img src="/project-feature-v1.jpg" alt="İncek Vadi Evleri modern yaşam projesi" className="absolute inset-0 h-full w-full object-cover transition duration-700 group-hover:scale-[1.025]" />
            <div className="absolute inset-0 bg-gradient-to-r from-white via-white/88 to-white/10" />
            <div className="relative z-10 flex min-h-[370px] max-w-[78%] flex-col justify-between p-7 sm:max-w-[54%] sm:p-10">
              <div><span className="flex items-center gap-3 text-[10px] font-black tracking-[.34em] text-slate-600"><span className="h-[2px] w-8 bg-red-700" /> YENİ PROJELER</span><h2 className="mt-7 text-4xl font-light tracking-tight text-[#071d3b] sm:text-5xl">İncek <strong className="font-black">Vadi Evleri</strong></h2><p className="mt-4 max-w-sm text-sm font-medium leading-6 text-slate-600 sm:text-base">Doğayla iç içe, modern yaşam alanlarıyla Ankara’nın yeni yaşam projesi.</p><Link to="/projelerimiz" className="mt-6 inline-flex items-center gap-3 rounded-full bg-red-700 px-6 py-3.5 text-sm font-black text-white shadow-lg shadow-red-900/20 transition hover:bg-red-800">Projeleri İncele <ArrowRight className="h-4 w-4" /></Link></div>
          ...
          <aside className="relative overflow-hidden rounded-3xl bg-[#cd011e] p-8 text-white shadow-xl sm:p-10"><img src="/project-feature-v1.jpg" alt="" aria-hidden="true" className="pointer-events-none absolute inset-0 h-full w-full object-cover opacity-[.11] grayscale" /><div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-[#e10626]/90 via-[#cd011e]/95 to-[#a8001a]/95" /><div className="relative z-10 flex h-full flex-col"><span className="flex items-center gap-3 text-[10px] font-black tracking-[.27em] text-white/85"><span className="h-[2px] w-8 bg-white" /> YATIRIM FIRSATLARI</span><h2 className="mt-7 text-3xl font-black leading-[1.16] tracking-tight sm:text-4xl">Yatırımlarınıza doğru projeler ile başlayın</h2><p className="mt-6 text-sm font-medium leading-7 text-white/90">Konut ve ticari projelerde lokasyon, değerleme ve satış süreçlerini uzmanlarımızla planlayın.</p><Link to="/projelerimiz" className="mt-auto inline-flex w-fit items-center gap-3 rounded-full bg-white px-6 py-3.5 text-sm font-black text-red-700 shadow-lg transition hover:bg-red-50">Projeleri Gör <ArrowRight className="h-4 w-4" /></Link></div></aside>
        </div>
      </section>
