      ...
      <div className="mx-auto max-w-[1360px] px-3 sm:px-5 lg:px-6">
        ...
        <section className="grid items-start gap-4 xl:grid-cols-[minmax(0,1.15fr)_320px_275px]">
          <div className="min-w-0">
            ...
            <div className="mt-1.5 grid grid-cols-5 gap-1.5 sm:grid-cols-7">{gallery.map((image, index) => <button key={`${image}-${index}`} onClick={() => setActiveImage(index)} className={`h-16 overflow-hidden border-2 bg-slate-100 ${activeImage === index ? 'border-red-700' : 'border-slate-200 hover:border-red-300'}`}><img src={image} alt="" className="h-full w-full object-cover"/></button>)}</div>
          </div>
        ...
        <section className="mt-6 xl:-mt-[390px] xl:w-[calc(100%-627px)]">
