...
function BarterBankModule() {
  ...
  const fields = (kind: string) => kind === 'Gayrimenkul' ? ['Şehir','İlçe','Mahalle','Konut özellikleri','Fiyat'] : kind === 'Otomobil' ? ['Marka','Model','Yıl','Fiyat','Şehir / İlçe'] : ['Açıklama','Fiyat','Şehir / İlçe'];
