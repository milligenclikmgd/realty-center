  ...
  return (
    <>
      ...
      <section className="bg-slate-950 py-16 text-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid gap-10 lg:grid-cols-2 items-center"><div><span className="text-xs font-black tracking-widest text-red-300">11 · REALTY CENTER HAKKINDA</span><img src="/rlogo.png" alt="Realty Center" className="mt-4 h-16 w-auto rounded bg-white p-2"/><h2 className="mt-5 text-3xl font-black">Gayrimenkulde güven odaklı büyüyen ağ.</h2><p className="mt-4 max-w-xl text-sm leading-relaxed text-slate-300">Kurumsal hikâye, vizyon, misyon ve marka ilkeleri bu alanda gerçek içeriklerle güncellenecektir.</p></div><div className="rounded-3xl border border-white/15 bg-white/5 p-8"><p className="text-xs font-black tracking-widest text-red-300">İLETİŞİM</p><h3 className="mt-3 text-2xl font-black">Size en yakın uzmanla görüşün.</h3><p className="mt-3 text-sm text-slate-300">İletişim bilgileri panelden girildiğinde burada otomatik görüntülenecektir.</p><Link to="/iletisim" className="mt-6 inline-flex rounded-xl bg-red-700 px-5 py-3 text-sm font-black hover:bg-red-800">İletişime Geç</Link></div></div>
      </section>

      <section className="bg-white py-16 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid gap-6 lg:grid-cols-2">
          <div className="rounded-3xl bg-red-700 p-8 text-white"><span className="text-xs font-black tracking-widest text-red-100">KARİYER</span><h2 className="mt-3 text-3xl font-black">Gayrimenkul kariyerine güçlü bir başlangıç.</h2><p className="mt-4 text-sm leading-relaxed text-red-50">Danışmanlık fırsatları, eğitimler ve kariyer başvuruları bu alandan yönetilecektir.</p><button onClick={() => openDrawer('agent')} className="mt-6 rounded-xl bg-white px-5 py-3 text-sm font-black text-red-700">DEMO Kariyer Başvurusu</button></div>
      ...
      <section className="bg-slate-50 py-10 border-b border-slate-200"><div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between"><div><span className="text-xs font-black tracking-widest text-red-700">SOSYAL MEDYA</span><h2 className="mt-1 text-2xl font-black text-slate-900">Realty Center’ı takip edin.</h2></div><div className="flex gap-3"><a href="#" className="rounded-xl bg-white border border-slate-200 px-4 py-3 text-sm font-black text-slate-700">Instagram</a><a href="#" className="rounded-xl bg-white border border-slate-200 px-4 py-3 text-sm font-black text-slate-700">LinkedIn</a><a href="#" className="rounded-xl bg-white border border-slate-200 px-4 py-3 text-sm font-black text-slate-700">YouTube</a></div></div></section>
