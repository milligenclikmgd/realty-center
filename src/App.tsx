...
import { 
  ...
  ShieldAlert, Lock, Check, XCircle, AlertCircle, FileText, PieChart, Layers, HelpCircle, MessageCircle, Menu, Instagram, Linkedin, Youtube
} from 'lucide-react';
    ...
    <>
      ...
      <section id="kurumsal" className="py-16 px-6 lg:px-12 max-w-7xl mx-auto border-b border-slate-200">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <span className="text-xs font-black text-red-700 tracking-widest bg-red-200 px-3.5 py-1.5 rounded-full border border-red-300">MARKA DEĞERİMİZ</span>
          <h2 className="text-4xl sm:text-5xl font-black text-slate-900 mt-4 tracking-tight">NEDEN <span className="text-red-700">REALTY CENTER?</span></h2>
