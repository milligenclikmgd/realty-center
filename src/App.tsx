...
function ListingCategoriesPage() {
  const navigate = useNavigate();
  const groups = [
    { title: 'Satılık Gayrimenkuller', label: 'SATILIK', transaction: 'Satılık', icon: Home, accent: '#CD011E', items: [['Konut','Ev','https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80&w=900'],['Villa','Villa','https://images.unsplash.com/photo-1613490493576-7fde63acd811?auto=format&fit=crop&q=80&w=900'],['Arsa','Arsa','https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&q=80&w=900']] },
