...
function ListingActionShortcuts() {
  return <aside className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1"><Link to="/#barter-bank" className="border border-red-200 bg-red-50 p-4 transition hover:bg-red-100"><p className="text-[10px] font-black tracking-widest text-red-700">BARTER BANK</p><strong className="mt-1 block text-sm text-slate-900">Takas fırsatlarını görün →</strong></Link><Link to="/#buyer-request" className="border border-slate-200 bg-slate-50 p-4 transition hover:bg-white"><p className="text-[10px] font-black tracking-widest text-red-700">SİZ ARADIĞINIZI SÖYLEYİN</p><strong className="mt-1 block text-sm text-slate-900">Size uygun ilanı bulalım →</strong></Link></aside>;
}
