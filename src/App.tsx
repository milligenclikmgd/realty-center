...
function TurkeyListingMap() {
  ...
  return (
    <section className="bg-white py-12 text-slate-900 overflow-hidden border-b border-slate-200 ambient-fabric">
...
function HomePage({ counts, currentSlide, selectedCity, setSelectedCity, openDrawer }: any) {
  ...
  return (
    <>
      ...
      <section className="bg-white py-10 text-slate-900 border-b border-slate-200 shadow-sm ambient-fabric">
      ...
      <section className="py-16 bg-white text-slate-900 overflow-hidden border-b border-slate-200 ambient-fabric">
      ...
      <section id="akademi" className="py-20 px-6 lg:px-12 bg-white text-slate-900 border-b-4 border-red-700 relative overflow-hidden ambient-fabric">
